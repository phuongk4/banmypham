<?php 
	class controller_them_sua_slide{
		public $model;
		public function __construct(){
			...
			switch($act){
				...
				case "edit":
					...
					$form_action = "admin.php?controller=them_sua_slide&act=do_edit&id=$id";
					//load view
					include "view/backend/view_them_sua_slide.php";
				break;
				case "do_edit":
					$c_name = $_POST["c_name"];
					// $fk_category_slide_id = $_POST["fk_category_slide_id"];
					...
					echo '<META HTTP-EQUIV="Refresh" Content="0; URL=admin.php?controller=slide">';
					// header("location:admin.php?controller=slide");
				break;
				//----
				case "add":
					$form_action = "admin.php?controller=them_sua_slide&act=do_add";
					//load view
					include "view/backend/view_them_sua_slide.php";
				break;
				//----
