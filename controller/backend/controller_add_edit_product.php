		...
		public function __construct(){
			...
			switch($act){
				...
				case "do_add":
					...
					$this->model->execute("insert into tbl_product(c_name,c_price,c_description,c_content,c_img,c_hotproduct,fk_category_product_id) values('$c_name','$c_price','$c_description','$c_content','$c_img','$c_hotproduct','$fk_category_product_id')");
					//------------
					//quay lai trang tin tuc
					echo '<META HTTP-EQUIV="Refresh" Content="0; URL=admin.php?controller=product">';
				break;
