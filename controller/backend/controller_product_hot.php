		...
		public function __construct(){
			...
			switch($act){
				case "delete":
					...
					$this->model->execute("delete from tbl_product_hot where pk_product_id=$id");
			...
			$total = $this->model->get_num_rows("select c_name from tbl_product_hot");
			...
			//------------
			$arr = $this->model->get_all("select * from tbl_product_hot order by pk_product_id desc limit $from,$record_per_page");
			//load view
