		...
		public function __construct(){
			...
			switch($act){
				case "delete":
					...
					$this->model->execute("delete from tbl_admin where pk_user_id=$id");
			...
			$total = $this->model->get_num_rows("select pk_user_id from tbl_admin");
			//tinh so trang
			...
			//lay cac ban ghi
			$arr = $this->model->get_all("select * from tbl_admin order by pk_user_id desc limit $from,$record_perpage");
			//---------
			//load view
