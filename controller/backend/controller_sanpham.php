		...
		public function __construct(){
			...
			switch($act){
				case "delete":
					...
					$this->model->execute("delete from tbl_sanpham where id_sp=$id");
			...
			$total = $this->model->get_num_rows("select c_name from tbl_sanpham");
			...
			//------------
			$arr = $this->model->get_all("select * from tbl_sanpham order by id_sp desc limit $from,$record_per_page");
			//load view
			include "view/backend/view_sanpham.php";
			//------------
		}
	}
