<div class="row justify-content-center">
	<div class="col-md-12">
		...
		<div style="margin:15px 0px">
			<a href="admin.php?controller=them_sua_sanpham_new&act=add" class="btn btn-primary">Add</a>
		</div>
...
<?php 
 ...
 ?>
						...
						<td style="text-align: center;">
<a href="admin.php?controller=them_sua_sanpham_new&act=edit&id=<?php echo $rows->id_sp; ?>">Edit</a>&nbsp;&nbsp;
<a onclick="return window.confirm('Are you sure?');" href="admin.php?controller=product_new&act=delete&id=<?php echo $rows->id_sp; ?>">Delete</a>
						</td>
					</tr>
				<?php } ?>
				</table>
