<div class="featuredproductslider-container"> 
    <div class="title-group1"><h2> <?php
            $category = $this->model->get_a_record("select c_name from tbl_loaisp where id_loaisp = $id");
            ...
            <div class='productslider-item item'>
                <div class="item-inner">
                    ...
                    <div class="des-container">
                        <h2 style="text-align: center;" class="product-name"><a href="#" title="<a href="index.php?controller=sanpham_chitiet&id=<?php echo $rows->id_sp; ?>" class="jt" ><?php echo $rows->c_name; ?></a></h2>
